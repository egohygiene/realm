...
id: realm-design-system
title: Realm Design System
...
This document defines reusable semantic language for Realm's documentation, terminal output, diagrams, reports, sites, and future interactive surfaces. It does not freeze a framework, component library, or final visual identity.
...
The expression should remain technical, spacious, environment-oriented, and transparent about image weight and capability cost while allowing product-specific identity to vary inside Ego Hygiene's broader family.
